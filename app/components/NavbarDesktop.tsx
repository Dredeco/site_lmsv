...
const NavbarDesktop = () => {
    ...
    return (
        <Container 
            className={`hidden lg:flex fixed w-full text-[1.6rem] items-center py-0 justify-between min-h-[112px] z-30 transition-all duration-100 ${(isScrolled || actualPage === 'contato') ? 'bg-white shadow-lg' : 'bg-transparent'}`}
        >
