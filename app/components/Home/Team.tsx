...
const Team = () => {
    ...
    return (
        <section className="h-auto py-20 text-black  w-full max-w-[1920px] bg-white px-[272px]">
            ...
            <div className="mt-[51px] flex">
                <h1 className="flex-1 max-w-[50%] text-[42px] leading-[50.40px]">
            ...
            <div className="flex flex-col items-center w-full mt-[50px] h-fit">
            <div className="flex gap-4 flex-wrap mb-[40px]">
            {team.map((lawer: any, index: any) => {
                return (
                <div id={index} className="max-w-[24%] h-fit">
                    <Image 
                    src={TeamImage}
                    alt={lawer.name}
                    ...
                    <span className="font-semibold text-[#8e1730] text-2xl uppercase">{lawer.name}</span> 
                    <br/>
                    <p className="mt-3 mb-2 font-light text-2xl">{lawer.OAB}</p>
                    <a href={lawer.linkedin}>
