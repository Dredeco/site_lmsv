			...
			<Container>
				<div className="flex w-full flex-col pt-[80px] justify-center">
					...
					<span className="text-[1.4rem] lg:text-[1.8rem] text-[#424847] font-normal w-full lg:max-w-[680px] tracking-[-0.36px] leading-[160%] mb-[40px]">
						A equipe Leão, Moreno, Scisinio e Vianna Advogados é composta por
						advogados especializados em crimes tributários,matérias inerentes ao
						direito penal econômico, crimes contra a honra, crimes eleitorais e
						crimes da competênciado Tribunal do Júri.
					</span>
				</div>

				<Image src={heroBackground} alt="" priority quality={100} />
			</Container>
		</div>
	);
};
