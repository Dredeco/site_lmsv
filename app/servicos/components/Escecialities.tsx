	...
	return (
		<Container className={'bg-[#8E1730]'}>
			...
			<div className="text-white h-auto">
				...
				<div className="grid mt-[40px] h-auto grid-cols-[repeat(auto-fit,_minmax(272px,_446px))] gap-[16px]">
					{especialities.map((especiality: any) => {
						return (
							<div
								key={especiality.name}
								className="w-full flex px-[29px] py-[61px] flex-col justify-between lg:justify-normal lg:gap-[145px] bg-black h-[434px] max-h-[434px] max-w-[447px] relative">
								<Image
								...
								/>
								<span
									className="z-10 text-[2.4rem] font-light leading-[108.474%] tracking-[-0.651px]"
									dangerouslySetInnerHTML={{ __html: especiality.name }}
								/>
								<span
									className="z-10 text-[1.4rem] font-light leading-[160%] tracking-[-0.36px] carousel-description"
